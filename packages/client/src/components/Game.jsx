...
export default function Game() {
  ...
  // Reset contribution/vote state when phase changes
  if (phase === 'contribution' && hasContributed && !iLocked) setHasContributed(false)
  if (phase === 'vote' && hasVoted && !voteState?.isActive) setHasVoted(false)
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="w-48 bg-stone-900 border-r border-stone-700 p-3 flex flex-col gap-2">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          {/* Resources */}
          <div className="bg-stone-900 border-b border-stone-700 px-4 py-3 grid grid-cols-4 gap-4">
        ...
        <div className="w-64 bg-stone-900 border-l border-stone-700 flex flex-col">
          ...
          <form onSubmit={handleChat} className="p-2 flex gap-2">
            <input
